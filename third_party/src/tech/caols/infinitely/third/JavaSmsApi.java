package tech.caols.infinitely.third;
...
public class JavaSmsApi {
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String apikey = "71bdc979933a6847405d8cda82f78fdf";
...
//        Integer duration = 30*60;// 绑定30分钟
    ...
    private static final Logger logger = LogManager.getLogger(JavaSmsApi.class);

    public static String sendCaptcha(String phone, String captcha) {
        String apikey = "71bdc979933a6847405d8cda82f78fdf";
        long tpl_id = 1771152;
        try {
            String tpl_value = URLEncoder.encode("#code#",ENCODING) +"="
                    + URLEncoder.encode("1234", ENCODING);
            return JavaSmsApi.tplSendSms(apikey, tpl_id, tpl_value, phone);
        } catch (IOException e) {
            logger.catching(e);
            return e.getMessage();
        }
